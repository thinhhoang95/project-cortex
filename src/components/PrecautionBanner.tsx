...
export default function PrecautionBanner({ positionClass = "bottom-4", regulationPrecaution = false }: PrecautionBannerProps) {
  return (
    <div className={`absolute ${positionClass} left-1/2 transform -translate-x-1/2 bg-white-600/30 backdrop-blur-sm text-xs text-gray-400 pointer-events-none text-center px-4 py-2 rounded-lg z-20`}>
